...
class GameView(context: Context?, attrs: AttributeSet?) : FrameLayout(context!!, attrs) {
    ...
    private val musicArray = arrayOf(MusicType.Bet, MusicType.ShuffleSingle, MusicType.Count, MusicType.Win, MusicType.Background, MusicType.Pressed, MusicType.Cheer0, MusicType.ShuffleAll, MusicType.Lost, MusicType.Draw)
    ...
    private fun initView() {
        coinView.coinCallback = object : CoinView.CoinCallback {
